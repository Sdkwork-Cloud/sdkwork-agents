use sdkwork_intelligence_agents_service::{
    ActivateAgentProviderBindingCommand, AgentsService, AgentImplementationKind,
...
fn subject() -> PolicySubject {
    PolicySubject::new("user.1", "100001").with_role("owner")
}
...
fn activating_provider_binding_deactivates_previous_default() {
    ...
    let bindings = service
        .list_provider_bindings(100_001, "agent.intelligence.rig-general", subject())
...
fn listing_provider_bindings_and_deployments_requires_existing_agent() {
    ...
    let binding_error = service
        .list_provider_bindings(100_001, "agent.missing", subject())
    ...
    let deployment_error = service
        .list_deployments(100_001, "agent.missing", subject())
...
fn deployment_preserves_binding_snapshot_after_provider_switch() {
    ...
    let deployments = service
        .list_deployments(100_001, "agent.intelligence.rig-general", subject())
