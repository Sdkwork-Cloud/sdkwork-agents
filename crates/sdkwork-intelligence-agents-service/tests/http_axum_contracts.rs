...
async fn backend_knowledge_document_request_should_accept_document_profile_and_store_compatible_metadata(
    ...
    post_json(
        &app,
        "/backend/v3/api/ai/knowledge_bases?tenant_id=100001",
        json!({
    ...
    let response = post_json(
        &app,
        "/backend/v3/api/ai/knowledge_bases/knowledge.base.backend.pc.structured.docs/documents?tenant_id=100001",
        json!({
...
async fn backend_update_knowledge_document_profile_should_preserve_existing_metadata() {
    ...
    post_json(
        &app,
        "/backend/v3/api/ai/knowledge_bases/knowledge.base.backend.pc.update.docs/documents?tenant_id=100001",
        json!({
    ...
    let response = patch_json(
        &app,
        "/backend/v3/api/ai/knowledge_documents/knowledge.document.backend.pc.update.manual?tenant_id=100001",
        json!({
            "documentProfile": {
                "author": "SDKWork Backend Docs",
