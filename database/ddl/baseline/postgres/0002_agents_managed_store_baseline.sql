...
-- Component: sdkwork-intelligence-agents-service
-- Domain: intelligence
-- Version: 0.1.0
...
CREATE OR REPLACE FUNCTION sdkwork_intelligence_agents_service_memory_modes_json_is_standard(input TEXT)
RETURNS BOOLEAN
LANGUAGE plpgsql
IMMUTABLE
AS $$
...
CREATE OR REPLACE FUNCTION sdkwork_intelligence_agents_service_knowledge_modes_json_is_standard(input TEXT)
RETURNS BOOLEAN
LANGUAGE plpgsql
IMMUTABLE
AS $$
