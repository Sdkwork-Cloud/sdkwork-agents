...
Choose the narrowest verification for the changed surface. Run application typecheck, tests, and build for H5 changes; run workspace-wide checks only when the change crosses that boundary.

## Agent Execution Rules

Follow specifications before memory and evidence before completion. Keep SDK construction, authentication, runtime environment selection, and route composition in their owning layers.
