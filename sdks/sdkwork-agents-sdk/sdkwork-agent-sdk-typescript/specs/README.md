...
This directory is the local SDKWork component contract for `@sdkwork/agents-sdk`.

- Component root: `sdkwork-agents/sdks/sdkwork-agents-sdk/sdkwork-agents-sdk-typescript`
