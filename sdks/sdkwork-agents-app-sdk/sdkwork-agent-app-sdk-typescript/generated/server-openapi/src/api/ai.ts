...
/** Upsert an agent memory retrieval index */
  async upsert(body: UpsertMemoryRetrievalIndexRequest): Promise<MemoryRetrievalIndexResponse> {
    return this.client.post<MemoryRetrievalIndexResponse>(appApiPath(`/ai/memory_retrieval_indexes`), body, undefined, undefined, 'application/json');
  }
}
...
/** Create a graph relation for one agent memory record */
  async create(memoryId: string, body: CreateMemoryRelationRequest): Promise<MemoryRelationResponse> {
    return this.client.post<MemoryRelationResponse>(appApiPath(`/ai/memory_records/${serializePathParameter(memoryId, { name: 'memoryId', style: 'simple', explode: false })}/relations`), body, undefined, undefined, 'application/json');
  }
}
...
/** Create a provenance source for one agent memory record */
  async create(memoryId: string, body: CreateMemorySourceRequest): Promise<MemorySourceResponse> {
    return this.client.post<MemorySourceResponse>(appApiPath(`/ai/memory_records/${serializePathParameter(memoryId, { name: 'memoryId', style: 'simple', explode: false })}/sources`), body, undefined, undefined, 'application/json');
  }
}
...
/** Create an agent memory record in one namespace */
  async create(memoryNamespaceId: string, body: CreateMemoryRecordRequest): Promise<MemoryRecordResponse> {
    return this.client.post<MemoryRecordResponse>(appApiPath(`/ai/memory_namespaces/${serializePathParameter(memoryNamespaceId, { name: 'memoryNamespaceId', style: 'simple', explode: false })}/records`), body, undefined, undefined, 'application/json');
  }

/** Retrieve one agent memory record */
  async retrieve(memoryId: string): Promise<MemoryRecordResponse> {
    return this.client.get<MemoryRecordResponse>(appApiPath(`/ai/memory_records/${serializePathParameter(memoryId, { name: 'memoryId', style: 'simple', explode: false })}`));
  }
...
/** Restore one soft-deleted agent memory record */
  async restore(memoryId: string, body: RestoreAgentRequest): Promise<MemoryRecordResponse> {
    return this.client.post<MemoryRecordResponse>(appApiPath(`/ai/memory_records/${serializePathParameter(memoryId, { name: 'memoryId', style: 'simple', explode: false })}/restore`), body, undefined, undefined, 'application/json');
  }
}
...
/** Create an agent memory namespace */
  async create(body: CreateMemoryNamespaceRequest): Promise<MemoryNamespaceResponse> {
    return this.client.post<MemoryNamespaceResponse>(appApiPath(`/ai/memory_namespaces`), body, undefined, undefined, 'application/json');
  }

/** Retrieve one agent memory namespace */
  async retrieve(memoryNamespaceId: string): Promise<MemoryNamespaceResponse> {
    return this.client.get<MemoryNamespaceResponse>(appApiPath(`/ai/memory_namespaces/${serializePathParameter(memoryNamespaceId, { name: 'memoryNamespaceId', style: 'simple', explode: false })}`));
  }
}
...
/** Create an agent memory profile binding */
  async create(memoryProfileId: string, body: CreateMemoryBindingRequest): Promise<MemoryBindingResponse> {
    return this.client.post<MemoryBindingResponse>(appApiPath(`/ai/memory_profiles/${serializePathParameter(memoryProfileId, { name: 'memoryProfileId', style: 'simple', explode: false })}/bindings`), body, undefined, undefined, 'application/json');
  }

/** Retrieve one agent memory binding */
  async retrieve(memoryBindingId: string): Promise<MemoryBindingResponse> {
    return this.client.get<MemoryBindingResponse>(appApiPath(`/ai/memory_bindings/${serializePathParameter(memoryBindingId, { name: 'memoryBindingId', style: 'simple', explode: false })}`));
  }
}
...
/** Create an agent memory profile for one store */
  async create(memoryStoreId: string, body: CreateMemoryProfileRequest): Promise<MemoryProfileResponse> {
    return this.client.post<MemoryProfileResponse>(appApiPath(`/ai/memory_stores/${serializePathParameter(memoryStoreId, { name: 'memoryStoreId', style: 'simple', explode: false })}/profiles`), body, undefined, undefined, 'application/json');
  }

/** Retrieve one agent memory profile */
  async retrieve(memoryProfileId: string): Promise<MemoryProfileResponse> {
    return this.client.get<MemoryProfileResponse>(appApiPath(`/ai/memory_profiles/${serializePathParameter(memoryProfileId, { name: 'memoryProfileId', style: 'simple', explode: false })}`));
  }
}
...
/** Create an agent memory store */
  async create(body: CreateMemoryStoreRequest): Promise<MemoryStoreResponse> {
    return this.client.post<MemoryStoreResponse>(appApiPath(`/ai/memory_stores`), body, undefined, undefined, 'application/json');
  }

/** Retrieve one agent memory store */
  async retrieve(memoryStoreId: string): Promise<MemoryStoreResponse> {
    return this.client.get<MemoryStoreResponse>(appApiPath(`/ai/memory_stores/${serializePathParameter(memoryStoreId, { name: 'memoryStoreId', style: 'simple', explode: false })}`));
  }

/** Update one agent memory store */
  async update(memoryStoreId: string, body: UpdateMemoryStoreRequest): Promise<MemoryStoreResponse> {
    return this.client.patch<MemoryStoreResponse>(appApiPath(`/ai/memory_stores/${serializePathParameter(memoryStoreId, { name: 'memoryStoreId', style: 'simple', explode: false })}`), body, undefined, undefined, 'application/json');
  }
}
...
/** Create a sync job for one agent knowledge base */
  async create(knowledgeBaseId: string, body: CreateKnowledgeSyncJobRequest): Promise<KnowledgeSyncJobResponse> {
    return this.client.post<KnowledgeSyncJobResponse>(appApiPath(`/ai/knowledge_bases/${serializePathParameter(knowledgeBaseId, { name: 'knowledgeBaseId', style: 'simple', explode: false })}/sync_jobs`), body, undefined, undefined, 'application/json');
  }

/** Retrieve one agent knowledge sync job */
  async retrieve(syncJobId: string): Promise<KnowledgeSyncJobResponse> {
    return this.client.get<KnowledgeSyncJobResponse>(appApiPath(`/ai/knowledge_sync_jobs/${serializePathParameter(syncJobId, { name: 'syncJobId', style: 'simple', explode: false })}`));
  }
...
/** Start one agent knowledge sync job */
  async start(syncJobId: string, body: StartKnowledgeSyncJobRequest): Promise<KnowledgeSyncJobResponse> {
    return this.client.post<KnowledgeSyncJobResponse>(appApiPath(`/ai/knowledge_sync_jobs/${serializePathParameter(syncJobId, { name: 'syncJobId', style: 'simple', explode: false })}/start`), body, undefined, undefined, 'application/json');
  }
...
/** Complete one agent knowledge sync job */
  async complete(syncJobId: string, body: CompleteKnowledgeSyncJobRequest): Promise<KnowledgeSyncJobResponse> {
    return this.client.post<KnowledgeSyncJobResponse>(appApiPath(`/ai/knowledge_sync_jobs/${serializePathParameter(syncJobId, { name: 'syncJobId', style: 'simple', explode: false })}/complete`), body, undefined, undefined, 'application/json');
  }
...
/** Fail one agent knowledge sync job */
  async fail(syncJobId: string, body: FailKnowledgeSyncJobRequest): Promise<KnowledgeSyncJobResponse> {
    return this.client.post<KnowledgeSyncJobResponse>(appApiPath(`/ai/knowledge_sync_jobs/${serializePathParameter(syncJobId, { name: 'syncJobId', style: 'simple', explode: false })}/fail`), body, undefined, undefined, 'application/json');
  }
...
/** Cancel one agent knowledge sync job */
  async cancel(syncJobId: string, body: CancelKnowledgeSyncJobRequest): Promise<KnowledgeSyncJobResponse> {
    return this.client.post<KnowledgeSyncJobResponse>(appApiPath(`/ai/knowledge_sync_jobs/${serializePathParameter(syncJobId, { name: 'syncJobId', style: 'simple', explode: false })}/cancel`), body, undefined, undefined, 'application/json');
  }
}
...
/** Create a binding for one agent knowledge base */
  async create(knowledgeBaseId: string, body: CreateKnowledgeBindingRequest): Promise<KnowledgeBindingResponse> {
    return this.client.post<KnowledgeBindingResponse>(appApiPath(`/ai/knowledge_bases/${serializePathParameter(knowledgeBaseId, { name: 'knowledgeBaseId', style: 'simple', explode: false })}/bindings`), body, undefined, undefined, 'application/json');
  }

/** Retrieve one agent knowledge binding */
  async retrieve(knowledgeBindingId: string): Promise<KnowledgeBindingResponse> {
    return this.client.get<KnowledgeBindingResponse>(appApiPath(`/ai/knowledge_bindings/${serializePathParameter(knowledgeBindingId, { name: 'knowledgeBindingId', style: 'simple', explode: false })}`));
  }
}
...
/** Upsert an agent knowledge retrieval index */
  async upsert(body: UpsertKnowledgeIndexRequest): Promise<KnowledgeIndexResponse> {
    return this.client.post<KnowledgeIndexResponse>(appApiPath(`/ai/knowledge_indexes`), body, undefined, undefined, 'application/json');
  }

/** Retrieve one agent knowledge retrieval index */
  async retrieve(knowledgeIndexId: string): Promise<KnowledgeIndexResponse> {
    return this.client.get<KnowledgeIndexResponse>(appApiPath(`/ai/knowledge_indexes/${serializePathParameter(knowledgeIndexId, { name: 'knowledgeIndexId', style: 'simple', explode: false })}`));
  }
}
...
/** Create a chunk for one agent knowledge document */
  async create(knowledgeDocumentId: string, body: CreateKnowledgeChunkRequest): Promise<KnowledgeChunkResponse> {
    return this.client.post<KnowledgeChunkResponse>(appApiPath(`/ai/knowledge_documents/${serializePathParameter(knowledgeDocumentId, { name: 'knowledgeDocumentId', style: 'simple', explode: false })}/chunks`), body, undefined, undefined, 'application/json');
  }

/** Retrieve one agent knowledge chunk */
  async retrieve(knowledgeChunkId: string): Promise<KnowledgeChunkResponse> {
    return this.client.get<KnowledgeChunkResponse>(appApiPath(`/ai/knowledge_chunks/${serializePathParameter(knowledgeChunkId, { name: 'knowledgeChunkId', style: 'simple', explode: false })}`));
  }
}
...
/** Read one provider-neutral knowledge document */
  async read(knowledgeDocumentId: string): Promise<KnowledgeDocumentResponse> {
    return this.client.get<KnowledgeDocumentResponse>(appApiPath(`/ai/knowledge_documents/${serializePathParameter(knowledgeDocumentId, { name: 'knowledgeDocumentId', style: 'simple', explode: false })}`));
  }
}
...
/** Search an agent knowledge base for provider-neutral RAG candidates */
  async search(knowledgeBaseId: string, body: SearchKnowledgeRequest): Promise<KnowledgeSearchResponse> {
    return this.client.post<KnowledgeSearchResponse>(appApiPath(`/ai/knowledge_bases/${serializePathParameter(knowledgeBaseId, { name: 'knowledgeBaseId', style: 'simple', explode: false })}/search`), body, undefined, undefined, 'application/json');
  }
}
...
/** Create a document for one agent knowledge base */
  async create(knowledgeBaseId: string, body: CreateKnowledgeDocumentRequest): Promise<KnowledgeDocumentResponse> {
    return this.client.post<KnowledgeDocumentResponse>(appApiPath(`/ai/knowledge_bases/${serializePathParameter(knowledgeBaseId, { name: 'knowledgeBaseId', style: 'simple', explode: false })}/documents`), body, undefined, undefined, 'application/json');
  }
...
/** Update one agent knowledge document */
  async update(knowledgeDocumentId: string, body: UpdateKnowledgeDocumentRequest): Promise<KnowledgeDocumentResponse> {
    return this.client.patch<KnowledgeDocumentResponse>(appApiPath(`/ai/knowledge_documents/${serializePathParameter(knowledgeDocumentId, { name: 'knowledgeDocumentId', style: 'simple', explode: false })}`), body, undefined, undefined, 'application/json');
  }
...
/** Restore one soft-deleted agent knowledge document */
  async restore(knowledgeDocumentId: string, body: RestoreAgentRequest): Promise<KnowledgeDocumentResponse> {
    return this.client.post<KnowledgeDocumentResponse>(appApiPath(`/ai/knowledge_documents/${serializePathParameter(knowledgeDocumentId, { name: 'knowledgeDocumentId', style: 'simple', explode: false })}/restore`), body, undefined, undefined, 'application/json');
  }
}
...
/** Create a source for one agent knowledge base */
  async create(knowledgeBaseId: string, body: CreateKnowledgeSourceRequest): Promise<KnowledgeSourceResponse> {
    return this.client.post<KnowledgeSourceResponse>(appApiPath(`/ai/knowledge_bases/${serializePathParameter(knowledgeBaseId, { name: 'knowledgeBaseId', style: 'simple', explode: false })}/sources`), body, undefined, undefined, 'application/json');
  }

/** Retrieve one agent knowledge source */
  async retrieve(knowledgeSourceId: string): Promise<KnowledgeSourceResponse> {
    return this.client.get<KnowledgeSourceResponse>(appApiPath(`/ai/knowledge_sources/${serializePathParameter(knowledgeSourceId, { name: 'knowledgeSourceId', style: 'simple', explode: false })}`));
  }
...
/** Update one agent knowledge source */
  async update(knowledgeSourceId: string, body: UpdateKnowledgeSourceRequest): Promise<KnowledgeSourceResponse> {
    return this.client.patch<KnowledgeSourceResponse>(appApiPath(`/ai/knowledge_sources/${serializePathParameter(knowledgeSourceId, { name: 'knowledgeSourceId', style: 'simple', explode: false })}`), body, undefined, undefined, 'application/json');
  }
...
/** Restore one soft-deleted agent knowledge source */
  async restore(knowledgeSourceId: string, body: RestoreAgentRequest): Promise<KnowledgeSourceResponse> {
    return this.client.post<KnowledgeSourceResponse>(appApiPath(`/ai/knowledge_sources/${serializePathParameter(knowledgeSourceId, { name: 'knowledgeSourceId', style: 'simple', explode: false })}/restore`), body, undefined, undefined, 'application/json');
  }
}
...
/** Create an agent knowledge base */
  async create(body: CreateKnowledgeBaseRequest): Promise<KnowledgeBaseResponse> {
    return this.client.post<KnowledgeBaseResponse>(appApiPath(`/ai/knowledge_bases`), body, undefined, undefined, 'application/json');
  }

/** Retrieve one agent knowledge base */
  async retrieve(knowledgeBaseId: string): Promise<KnowledgeBaseResponse> {
    return this.client.get<KnowledgeBaseResponse>(appApiPath(`/ai/knowledge_bases/${serializePathParameter(knowledgeBaseId, { name: 'knowledgeBaseId', style: 'simple', explode: false })}`));
  }
...
/** Update one agent knowledge base */
  async update(knowledgeBaseId: string, body: UpdateKnowledgeBaseRequest): Promise<KnowledgeBaseResponse> {
    return this.client.patch<KnowledgeBaseResponse>(appApiPath(`/ai/knowledge_bases/${serializePathParameter(knowledgeBaseId, { name: 'knowledgeBaseId', style: 'simple', explode: false })}`), body, undefined, undefined, 'application/json');
  }
...
/** Restore one soft-deleted agent knowledge base */
  async restore(knowledgeBaseId: string, body: RestoreAgentRequest): Promise<KnowledgeBaseResponse> {
    return this.client.post<KnowledgeBaseResponse>(appApiPath(`/ai/knowledge_bases/${serializePathParameter(knowledgeBaseId, { name: 'knowledgeBaseId', style: 'simple', explode: false })}/restore`), body, undefined, undefined, 'application/json');
  }
}
