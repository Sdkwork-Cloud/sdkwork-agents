...
This directory is the local SDKWork component contract for `@sdkwork/agents-app-sdk`.

- Component root: `sdkwork-agents/sdks/sdkwork-agents-app-sdk/sdkwork-agents-app-sdk-typescript`
