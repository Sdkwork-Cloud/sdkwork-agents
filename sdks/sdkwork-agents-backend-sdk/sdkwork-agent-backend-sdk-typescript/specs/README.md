...
This directory is the local SDKWork component contract for `@sdkwork/agents-backend-sdk`.

- Component root: `sdkwork-agents/sdks/sdkwork-agents-backend-sdk/sdkwork-agents-backend-sdk-typescript`
