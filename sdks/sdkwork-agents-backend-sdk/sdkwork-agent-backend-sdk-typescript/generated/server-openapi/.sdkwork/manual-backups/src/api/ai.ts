...
/** List retrieval indexes for one agent memory record */
  async list(memoryId: string, params: AiMemoryRetrievalIndexesListParams): Promise<MemoryRetrievalIndexListResponse> {
    ...
    return this.client.get<MemoryRetrievalIndexListResponse>(appendQueryString(backendApiPath(`/ai/memory_records/${serializePathParameter(memoryId, { name: 'memoryId', style: 'simple', explode: false })}/retrieval_indexes`), query));
  }
...
/** Upsert an agent memory retrieval index */
  async upsert(body: UpsertMemoryRetrievalIndexRequest, params: AiMemoryRetrievalIndexesUpsertParams): Promise<MemoryRetrievalIndexResponse> {
    ...
    return this.client.post<MemoryRetrievalIndexResponse>(appendQueryString(backendApiPath(`/ai/memory_retrieval_indexes`), query), body, undefined, undefined, 'application/json');
  }
}
...
/** List graph relations for one agent memory record */
  async list(memoryId: string, params: AiMemoryRelationsListParams): Promise<MemoryRelationListResponse> {
    ...
    return this.client.get<MemoryRelationListResponse>(appendQueryString(backendApiPath(`/ai/memory_records/${serializePathParameter(memoryId, { name: 'memoryId', style: 'simple', explode: false })}/relations`), query));
  }
...
/** Create a graph relation for one agent memory record */
  async create(memoryId: string, body: CreateMemoryRelationRequest, params: AiMemoryRelationsCreateParams): Promise<MemoryRelationResponse> {
    ...
    return this.client.post<MemoryRelationResponse>(appendQueryString(backendApiPath(`/ai/memory_records/${serializePathParameter(memoryId, { name: 'memoryId', style: 'simple', explode: false })}/relations`), query), body, undefined, undefined, 'application/json');
  }
}
...
/** List provenance sources for one agent memory record */
  async list(memoryId: string, params: AiMemorySourcesListParams): Promise<MemorySourceListResponse> {
    ...
    return this.client.get<MemorySourceListResponse>(appendQueryString(backendApiPath(`/ai/memory_records/${serializePathParameter(memoryId, { name: 'memoryId', style: 'simple', explode: false })}/sources`), query));
  }
...
/** Create a provenance source for one agent memory record */
  async create(memoryId: string, body: CreateMemorySourceRequest, params: AiMemorySourcesCreateParams): Promise<MemorySourceResponse> {
    ...
    return this.client.post<MemorySourceResponse>(appendQueryString(backendApiPath(`/ai/memory_records/${serializePathParameter(memoryId, { name: 'memoryId', style: 'simple', explode: false })}/sources`), query), body, undefined, undefined, 'application/json');
  }
}
...
/** List agent memory records in one namespace */
  async list(memoryNamespaceId: string, params: AiMemoryRecordsListParams): Promise<MemoryRecordListResponse> {
    ...
    return this.client.get<MemoryRecordListResponse>(appendQueryString(backendApiPath(`/ai/memory_namespaces/${serializePathParameter(memoryNamespaceId, { name: 'memoryNamespaceId', style: 'simple', explode: false })}/records`), query));
  }
...
/** Create an agent memory record in one namespace */
  async create(memoryNamespaceId: string, body: CreateMemoryRecordRequest, params: AiMemoryRecordsCreateParams): Promise<MemoryRecordResponse> {
    ...
    return this.client.post<MemoryRecordResponse>(appendQueryString(backendApiPath(`/ai/memory_namespaces/${serializePathParameter(memoryNamespaceId, { name: 'memoryNamespaceId', style: 'simple', explode: false })}/records`), query), body, undefined, undefined, 'application/json');
  }
...
/** Retrieve one agent memory record */
  async retrieve(memoryId: string, params: AiMemoryRecordsRetrieveParams): Promise<MemoryRecordResponse> {
    ...
    return this.client.get<MemoryRecordResponse>(appendQueryString(backendApiPath(`/ai/memory_records/${serializePathParameter(memoryId, { name: 'memoryId', style: 'simple', explode: false })}`), query));
  }
...
/** Soft-delete one agent memory record */
  async delete(memoryId: string, params: AiMemoryRecordsDeleteParams): Promise<MemoryRecordResponse> {
    ...
    return this.client.delete<MemoryRecordResponse>(appendQueryString(backendApiPath(`/ai/memory_records/${serializePathParameter(memoryId, { name: 'memoryId', style: 'simple', explode: false })}`), query));
  }
...
/** Restore one soft-deleted agent memory record */
  async restore(memoryId: string, body: RestoreAgentRequest, params: AiMemoryRecordsRestoreParams): Promise<MemoryRecordResponse> {
    ...
    return this.client.post<MemoryRecordResponse>(appendQueryString(backendApiPath(`/ai/memory_records/${serializePathParameter(memoryId, { name: 'memoryId', style: 'simple', explode: false })}/restore`), query), body, undefined, undefined, 'application/json');
  }
}
...
/** Create an agent memory namespace */
  async create(body: CreateMemoryNamespaceRequest, params: AiMemoryNamespacesCreateParams): Promise<MemoryNamespaceResponse> {
    ...
    return this.client.post<MemoryNamespaceResponse>(appendQueryString(backendApiPath(`/ai/memory_namespaces`), query), body, undefined, undefined, 'application/json');
  }
...
/** Retrieve one agent memory namespace */
  async retrieve(memoryNamespaceId: string, params: AiMemoryNamespacesRetrieveParams): Promise<MemoryNamespaceResponse> {
    ...
    return this.client.get<MemoryNamespaceResponse>(appendQueryString(backendApiPath(`/ai/memory_namespaces/${serializePathParameter(memoryNamespaceId, { name: 'memoryNamespaceId', style: 'simple', explode: false })}`), query));
  }
}
...
/** Create an agent memory profile binding */
  async create(memoryProfileId: string, body: CreateMemoryBindingRequest, params: AiMemoryBindingsCreateParams): Promise<MemoryBindingResponse> {
    ...
    return this.client.post<MemoryBindingResponse>(appendQueryString(backendApiPath(`/ai/memory_profiles/${serializePathParameter(memoryProfileId, { name: 'memoryProfileId', style: 'simple', explode: false })}/bindings`), query), body, undefined, undefined, 'application/json');
  }
...
/** Retrieve one agent memory binding */
  async retrieve(memoryBindingId: string, params: AiMemoryBindingsRetrieveParams): Promise<MemoryBindingResponse> {
    ...
    return this.client.get<MemoryBindingResponse>(appendQueryString(backendApiPath(`/ai/memory_bindings/${serializePathParameter(memoryBindingId, { name: 'memoryBindingId', style: 'simple', explode: false })}`), query));
  }
}
...
/** Create an agent memory profile for one store */
  async create(memoryStoreId: string, body: CreateMemoryProfileRequest, params: AiMemoryProfilesCreateParams): Promise<MemoryProfileResponse> {
    ...
    return this.client.post<MemoryProfileResponse>(appendQueryString(backendApiPath(`/ai/memory_stores/${serializePathParameter(memoryStoreId, { name: 'memoryStoreId', style: 'simple', explode: false })}/profiles`), query), body, undefined, undefined, 'application/json');
  }
...
/** Retrieve one agent memory profile */
  async retrieve(memoryProfileId: string, params: AiMemoryProfilesRetrieveParams): Promise<MemoryProfileResponse> {
    ...
    return this.client.get<MemoryProfileResponse>(appendQueryString(backendApiPath(`/ai/memory_profiles/${serializePathParameter(memoryProfileId, { name: 'memoryProfileId', style: 'simple', explode: false })}`), query));
  }
}
...
/** Create an agent memory store */
  async create(body: CreateMemoryStoreRequest, params: AiMemoryStoresCreateParams): Promise<MemoryStoreResponse> {
    ...
    return this.client.post<MemoryStoreResponse>(appendQueryString(backendApiPath(`/ai/memory_stores`), query), body, undefined, undefined, 'application/json');
  }
...
/** Retrieve one agent memory store */
  async retrieve(memoryStoreId: string, params: AiMemoryStoresRetrieveParams): Promise<MemoryStoreResponse> {
    ...
    return this.client.get<MemoryStoreResponse>(appendQueryString(backendApiPath(`/ai/memory_stores/${serializePathParameter(memoryStoreId, { name: 'memoryStoreId', style: 'simple', explode: false })}`), query));
  }
...
/** Update one agent memory store */
  async update(memoryStoreId: string, body: UpdateMemoryStoreRequest, params: AiMemoryStoresUpdateParams): Promise<MemoryStoreResponse> {
    ...
    return this.client.patch<MemoryStoreResponse>(appendQueryString(backendApiPath(`/ai/memory_stores/${serializePathParameter(memoryStoreId, { name: 'memoryStoreId', style: 'simple', explode: false })}`), query), body, undefined, undefined, 'application/json');
  }
}
...
/** List sync jobs for one agent knowledge base */
  async list(knowledgeBaseId: string, params: AiKnowledgeSyncJobsListParams): Promise<KnowledgeSyncJobListResponse> {
    ...
    return this.client.get<KnowledgeSyncJobListResponse>(appendQueryString(backendApiPath(`/ai/knowledge_bases/${serializePathParameter(knowledgeBaseId, { name: 'knowledgeBaseId', style: 'simple', explode: false })}/sync_jobs`), query));
  }
...
/** Create a sync job for one agent knowledge base */
  async create(knowledgeBaseId: string, body: CreateKnowledgeSyncJobRequest, params: AiKnowledgeSyncJobsCreateParams): Promise<KnowledgeSyncJobResponse> {
    ...
    return this.client.post<KnowledgeSyncJobResponse>(appendQueryString(backendApiPath(`/ai/knowledge_bases/${serializePathParameter(knowledgeBaseId, { name: 'knowledgeBaseId', style: 'simple', explode: false })}/sync_jobs`), query), body, undefined, undefined, 'application/json');
  }
...
/** Retrieve one agent knowledge sync job */
  async retrieve(syncJobId: string, params: AiKnowledgeSyncJobsRetrieveParams): Promise<KnowledgeSyncJobResponse> {
    ...
    return this.client.get<KnowledgeSyncJobResponse>(appendQueryString(backendApiPath(`/ai/knowledge_sync_jobs/${serializePathParameter(syncJobId, { name: 'syncJobId', style: 'simple', explode: false })}`), query));
  }
...
/** Start one agent knowledge sync job */
  async start(syncJobId: string, body: StartKnowledgeSyncJobRequest, params: AiKnowledgeSyncJobsStartParams): Promise<KnowledgeSyncJobResponse> {
    ...
    return this.client.post<KnowledgeSyncJobResponse>(appendQueryString(backendApiPath(`/ai/knowledge_sync_jobs/${serializePathParameter(syncJobId, { name: 'syncJobId', style: 'simple', explode: false })}/start`), query), body, undefined, undefined, 'application/json');
  }
...
/** Complete one agent knowledge sync job */
  async complete(syncJobId: string, body: CompleteKnowledgeSyncJobRequest, params: AiKnowledgeSyncJobsCompleteParams): Promise<KnowledgeSyncJobResponse> {
    ...
    return this.client.post<KnowledgeSyncJobResponse>(appendQueryString(backendApiPath(`/ai/knowledge_sync_jobs/${serializePathParameter(syncJobId, { name: 'syncJobId', style: 'simple', explode: false })}/complete`), query), body, undefined, undefined, 'application/json');
  }
...
/** Fail one agent knowledge sync job */
  async fail(syncJobId: string, body: FailKnowledgeSyncJobRequest, params: AiKnowledgeSyncJobsFailParams): Promise<KnowledgeSyncJobResponse> {
    ...
    return this.client.post<KnowledgeSyncJobResponse>(appendQueryString(backendApiPath(`/ai/knowledge_sync_jobs/${serializePathParameter(syncJobId, { name: 'syncJobId', style: 'simple', explode: false })}/fail`), query), body, undefined, undefined, 'application/json');
  }
...
/** Cancel one agent knowledge sync job */
  async cancel(syncJobId: string, body: CancelKnowledgeSyncJobRequest, params: AiKnowledgeSyncJobsCancelParams): Promise<KnowledgeSyncJobResponse> {
    ...
    return this.client.post<KnowledgeSyncJobResponse>(appendQueryString(backendApiPath(`/ai/knowledge_sync_jobs/${serializePathParameter(syncJobId, { name: 'syncJobId', style: 'simple', explode: false })}/cancel`), query), body, undefined, undefined, 'application/json');
  }
}
...
/** List bindings for one agent knowledge base */
  async list(knowledgeBaseId: string, params: AiKnowledgeBindingsListParams): Promise<KnowledgeBindingListResponse> {
    ...
    return this.client.get<KnowledgeBindingListResponse>(appendQueryString(backendApiPath(`/ai/knowledge_bases/${serializePathParameter(knowledgeBaseId, { name: 'knowledgeBaseId', style: 'simple', explode: false })}/bindings`), query));
  }
...
/** Create a binding for one agent knowledge base */
  async create(knowledgeBaseId: string, body: CreateKnowledgeBindingRequest, params: AiKnowledgeBindingsCreateParams): Promise<KnowledgeBindingResponse> {
    ...
    return this.client.post<KnowledgeBindingResponse>(appendQueryString(backendApiPath(`/ai/knowledge_bases/${serializePathParameter(knowledgeBaseId, { name: 'knowledgeBaseId', style: 'simple', explode: false })}/bindings`), query), body, undefined, undefined, 'application/json');
  }
...
/** Retrieve one agent knowledge binding */
  async retrieve(knowledgeBindingId: string, params: AiKnowledgeBindingsRetrieveParams): Promise<KnowledgeBindingResponse> {
    ...
    return this.client.get<KnowledgeBindingResponse>(appendQueryString(backendApiPath(`/ai/knowledge_bindings/${serializePathParameter(knowledgeBindingId, { name: 'knowledgeBindingId', style: 'simple', explode: false })}`), query));
  }
}
...
/** List indexes for one agent knowledge document */
  async list(knowledgeDocumentId: string, params: AiKnowledgeIndexesListParams): Promise<KnowledgeIndexListResponse> {
    ...
    return this.client.get<KnowledgeIndexListResponse>(appendQueryString(backendApiPath(`/ai/knowledge_documents/${serializePathParameter(knowledgeDocumentId, { name: 'knowledgeDocumentId', style: 'simple', explode: false })}/indexes`), query));
  }
...
/** Upsert an agent knowledge retrieval index */
  async upsert(body: UpsertKnowledgeIndexRequest, params: AiKnowledgeIndexesUpsertParams): Promise<KnowledgeIndexResponse> {
    ...
    return this.client.post<KnowledgeIndexResponse>(appendQueryString(backendApiPath(`/ai/knowledge_indexes`), query), body, undefined, undefined, 'application/json');
  }
...
/** Retrieve one agent knowledge retrieval index */
  async retrieve(knowledgeIndexId: string, params: AiKnowledgeIndexesRetrieveParams): Promise<KnowledgeIndexResponse> {
    ...
    return this.client.get<KnowledgeIndexResponse>(appendQueryString(backendApiPath(`/ai/knowledge_indexes/${serializePathParameter(knowledgeIndexId, { name: 'knowledgeIndexId', style: 'simple', explode: false })}`), query));
  }
}
...
/** List chunks for one agent knowledge document */
  async list(knowledgeDocumentId: string, params: AiKnowledgeChunksListParams): Promise<KnowledgeChunkListResponse> {
    ...
    return this.client.get<KnowledgeChunkListResponse>(appendQueryString(backendApiPath(`/ai/knowledge_documents/${serializePathParameter(knowledgeDocumentId, { name: 'knowledgeDocumentId', style: 'simple', explode: false })}/chunks`), query));
  }
...
/** Create a chunk for one agent knowledge document */
  async create(knowledgeDocumentId: string, body: CreateKnowledgeChunkRequest, params: AiKnowledgeChunksCreateParams): Promise<KnowledgeChunkResponse> {
    ...
    return this.client.post<KnowledgeChunkResponse>(appendQueryString(backendApiPath(`/ai/knowledge_documents/${serializePathParameter(knowledgeDocumentId, { name: 'knowledgeDocumentId', style: 'simple', explode: false })}/chunks`), query), body, undefined, undefined, 'application/json');
  }
...
/** Retrieve one agent knowledge chunk */
  async retrieve(knowledgeChunkId: string, params: AiKnowledgeChunksRetrieveParams): Promise<KnowledgeChunkResponse> {
    ...
    return this.client.get<KnowledgeChunkResponse>(appendQueryString(backendApiPath(`/ai/knowledge_chunks/${serializePathParameter(knowledgeChunkId, { name: 'knowledgeChunkId', style: 'simple', explode: false })}`), query));
  }
}
...
/** Read one provider-neutral knowledge document */
  async read(knowledgeDocumentId: string, params: AiKnowledgeReadReadParams): Promise<KnowledgeDocumentResponse> {
    ...
    return this.client.get<KnowledgeDocumentResponse>(appendQueryString(backendApiPath(`/ai/knowledge_documents/${serializePathParameter(knowledgeDocumentId, { name: 'knowledgeDocumentId', style: 'simple', explode: false })}`), query));
  }
}
...
/** Search an agent knowledge base for provider-neutral RAG candidates */
  async search(knowledgeBaseId: string, body: SearchKnowledgeRequest, params: AiKnowledgeSearchSearchParams): Promise<KnowledgeSearchResponse> {
    ...
    return this.client.post<KnowledgeSearchResponse>(appendQueryString(backendApiPath(`/ai/knowledge_bases/${serializePathParameter(knowledgeBaseId, { name: 'knowledgeBaseId', style: 'simple', explode: false })}/search`), query), body, undefined, undefined, 'application/json');
  }
}
...
/** Create a document for one agent knowledge base */
  async create(knowledgeBaseId: string, body: CreateKnowledgeDocumentRequest, params: AiKnowledgeDocumentsCreateParams): Promise<KnowledgeDocumentResponse> {
    ...
    return this.client.post<KnowledgeDocumentResponse>(appendQueryString(backendApiPath(`/ai/knowledge_bases/${serializePathParameter(knowledgeBaseId, { name: 'knowledgeBaseId', style: 'simple', explode: false })}/documents`), query), body, undefined, undefined, 'application/json');
  }
...
/** Update one agent knowledge document */
  async update(knowledgeDocumentId: string, body: UpdateKnowledgeDocumentRequest, params: AiKnowledgeDocumentsUpdateParams): Promise<KnowledgeDocumentResponse> {
    ...
    return this.client.patch<KnowledgeDocumentResponse>(appendQueryString(backendApiPath(`/ai/knowledge_documents/${serializePathParameter(knowledgeDocumentId, { name: 'knowledgeDocumentId', style: 'simple', explode: false })}`), query), body, undefined, undefined, 'application/json');
  }
...
/** Soft-delete one agent knowledge document */
  async delete(knowledgeDocumentId: string, params: AiKnowledgeDocumentsDeleteParams): Promise<KnowledgeDocumentResponse> {
    ...
    return this.client.delete<KnowledgeDocumentResponse>(appendQueryString(backendApiPath(`/ai/knowledge_documents/${serializePathParameter(knowledgeDocumentId, { name: 'knowledgeDocumentId', style: 'simple', explode: false })}`), query));
  }
...
/** Restore one soft-deleted agent knowledge document */
  async restore(knowledgeDocumentId: string, body: RestoreAgentRequest, params: AiKnowledgeDocumentsRestoreParams): Promise<KnowledgeDocumentResponse> {
    ...
    return this.client.post<KnowledgeDocumentResponse>(appendQueryString(backendApiPath(`/ai/knowledge_documents/${serializePathParameter(knowledgeDocumentId, { name: 'knowledgeDocumentId', style: 'simple', explode: false })}/restore`), query), body, undefined, undefined, 'application/json');
  }
}
...
/** List provider-neutral knowledge documents for one agent knowledge base */
  async list(knowledgeBaseId: string, params: AiKnowledgeListListParams): Promise<KnowledgeDocumentListResponse> {
    ...
    return this.client.get<KnowledgeDocumentListResponse>(appendQueryString(backendApiPath(`/ai/knowledge_bases/${serializePathParameter(knowledgeBaseId, { name: 'knowledgeBaseId', style: 'simple', explode: false })}/documents`), query));
  }
}
...
/** List sources for one agent knowledge base */
  async list(knowledgeBaseId: string, params: AiKnowledgeSourcesListParams): Promise<KnowledgeSourceListResponse> {
    ...
    return this.client.get<KnowledgeSourceListResponse>(appendQueryString(backendApiPath(`/ai/knowledge_bases/${serializePathParameter(knowledgeBaseId, { name: 'knowledgeBaseId', style: 'simple', explode: false })}/sources`), query));
  }
...
/** Create a source for one agent knowledge base */
  async create(knowledgeBaseId: string, body: CreateKnowledgeSourceRequest, params: AiKnowledgeSourcesCreateParams): Promise<KnowledgeSourceResponse> {
    ...
    return this.client.post<KnowledgeSourceResponse>(appendQueryString(backendApiPath(`/ai/knowledge_bases/${serializePathParameter(knowledgeBaseId, { name: 'knowledgeBaseId', style: 'simple', explode: false })}/sources`), query), body, undefined, undefined, 'application/json');
  }
...
/** Retrieve one agent knowledge source */
  async retrieve(knowledgeSourceId: string, params: AiKnowledgeSourcesRetrieveParams): Promise<KnowledgeSourceResponse> {
    ...
    return this.client.get<KnowledgeSourceResponse>(appendQueryString(backendApiPath(`/ai/knowledge_sources/${serializePathParameter(knowledgeSourceId, { name: 'knowledgeSourceId', style: 'simple', explode: false })}`), query));
  }
...
/** Update one agent knowledge source */
  async update(knowledgeSourceId: string, body: UpdateKnowledgeSourceRequest, params: AiKnowledgeSourcesUpdateParams): Promise<KnowledgeSourceResponse> {
    ...
    return this.client.patch<KnowledgeSourceResponse>(appendQueryString(backendApiPath(`/ai/knowledge_sources/${serializePathParameter(knowledgeSourceId, { name: 'knowledgeSourceId', style: 'simple', explode: false })}`), query), body, undefined, undefined, 'application/json');
  }
...
/** Soft-delete one agent knowledge source */
  async delete(knowledgeSourceId: string, params: AiKnowledgeSourcesDeleteParams): Promise<KnowledgeSourceResponse> {
    ...
    return this.client.delete<KnowledgeSourceResponse>(appendQueryString(backendApiPath(`/ai/knowledge_sources/${serializePathParameter(knowledgeSourceId, { name: 'knowledgeSourceId', style: 'simple', explode: false })}`), query));
  }
...
/** Restore one soft-deleted agent knowledge source */
  async restore(knowledgeSourceId: string, body: RestoreAgentRequest, params: AiKnowledgeSourcesRestoreParams): Promise<KnowledgeSourceResponse> {
    ...
    return this.client.post<KnowledgeSourceResponse>(appendQueryString(backendApiPath(`/ai/knowledge_sources/${serializePathParameter(knowledgeSourceId, { name: 'knowledgeSourceId', style: 'simple', explode: false })}/restore`), query), body, undefined, undefined, 'application/json');
  }
}
...
/** List agent knowledge bases */
  async list(params: AiKnowledgeBasesListParams): Promise<KnowledgeBaseListResponse> {
    ...
    return this.client.get<KnowledgeBaseListResponse>(appendQueryString(backendApiPath(`/ai/knowledge_bases`), query));
  }
...
/** Create an agent knowledge base */
  async create(body: CreateKnowledgeBaseRequest, params: AiKnowledgeBasesCreateParams): Promise<KnowledgeBaseResponse> {
    ...
    return this.client.post<KnowledgeBaseResponse>(appendQueryString(backendApiPath(`/ai/knowledge_bases`), query), body, undefined, undefined, 'application/json');
  }
...
/** Retrieve one agent knowledge base */
  async retrieve(knowledgeBaseId: string, params: AiKnowledgeBasesRetrieveParams): Promise<KnowledgeBaseResponse> {
    ...
    return this.client.get<KnowledgeBaseResponse>(appendQueryString(backendApiPath(`/ai/knowledge_bases/${serializePathParameter(knowledgeBaseId, { name: 'knowledgeBaseId', style: 'simple', explode: false })}`), query));
  }
...
/** Update one agent knowledge base */
  async update(knowledgeBaseId: string, body: UpdateKnowledgeBaseRequest, params: AiKnowledgeBasesUpdateParams): Promise<KnowledgeBaseResponse> {
    ...
    return this.client.patch<KnowledgeBaseResponse>(appendQueryString(backendApiPath(`/ai/knowledge_bases/${serializePathParameter(knowledgeBaseId, { name: 'knowledgeBaseId', style: 'simple', explode: false })}`), query), body, undefined, undefined, 'application/json');
  }
...
/** Soft-delete one agent knowledge base */
  async delete(knowledgeBaseId: string, params: AiKnowledgeBasesDeleteParams): Promise<KnowledgeBaseResponse> {
    ...
    return this.client.delete<KnowledgeBaseResponse>(appendQueryString(backendApiPath(`/ai/knowledge_bases/${serializePathParameter(knowledgeBaseId, { name: 'knowledgeBaseId', style: 'simple', explode: false })}`), query));
  }
...
/** Restore one soft-deleted agent knowledge base */
  async restore(knowledgeBaseId: string, body: RestoreAgentRequest, params: AiKnowledgeBasesRestoreParams): Promise<KnowledgeBaseResponse> {
    ...
    return this.client.post<KnowledgeBaseResponse>(appendQueryString(backendApiPath(`/ai/knowledge_bases/${serializePathParameter(knowledgeBaseId, { name: 'knowledgeBaseId', style: 'simple', explode: false })}/restore`), query), body, undefined, undefined, 'application/json');
  }
}
